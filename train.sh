...
TRAIN_CONFIGS=(
    "ddpm_gmm2d|cuda:0|--T 1000 --num_samples 1000000 --batch_size 50000 --epochs 200 --lr 1e-4 --hidden_dim 128 --num_blocks 4"
...
do
    (
        ...
        python src/train.py --runner "$runner" --device "$device" $extra_args || exit 1
    ) &
done
